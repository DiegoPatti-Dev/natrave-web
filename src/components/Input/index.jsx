export const Input = ({ name, label, error, ...props }) => (
  <div className="flex flex-col">
    ...
    <input {...props} name={name} id={name} className={`p-3 border border-grey-700 rounded-xl focus:outline focus:outline-1 focus:outline-grey-700 ${error && 'border-red-300'}`} />
